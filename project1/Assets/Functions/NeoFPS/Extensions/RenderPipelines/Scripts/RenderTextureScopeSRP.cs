...
namespace NeoFPS.SRPs
{
    [HelpURL("https://docs.neofps.com/manual/weaponsref-mb-rendertexturescopesrp.html")]
    public class RenderTextureScopeSRP : MonoBehaviour, INeoSerializableComponent
    {
        [Header("Camera")]
        ...
        // Constants
        const string k_ShaderParameterRenderTexture = "Texture2D_RenderTexture";
        const string k_ShaderParameterTransparency = "Vector1_ScopeTransparency";
        const string k_ShaderParameterParallax = "Vector2_ScopeParallax";
        const string k_ShaderParameterRingNormalised = "Vector1_ScopeRingNormalised";
        const string k_ShaderParameterRingFocus = "Vector1_ScopeRingFocus";

        private RenderTexture m_RenderTexture = null;
        private Material m_ScopeMaterial = null;
        ...
        public float transparency
        {
            ...
            set
            {
                ...
                if (clamped != m_Transparency || m_Force)
                {
                    ...
                    m_ScopeMaterial.SetFloat(m_KeyTransparency, m_Transparency);
                }
            }
        }
        ...
        public float scopeRingNormalised
        {
            ...
            set
            {
                ...
                if (m_ScopeRingNormalised != clamped || m_Force)
                {
                    ...
                    m_ScopeMaterial.SetFloat(m_KeyRingNormalised, m_ScopeRingNormalised);
                }
            }
        }
        ...
        public float scopeRingFocus
        {
            ...
            set
            {
                ...
                if (m_ScopeRingFocus != clamped || m_Force)
                {
                    ...
                    m_ScopeMaterial.SetFloat(m_KeyRingFocus, m_ScopeRingFocus);
                }
            }
        }
            ...
            set
            {
                    ...
                    m_Force)
                {
                    ...
                    if (m_ScopeRingParallax > 0.001f)
                    {
                        ...
                        m_ScopeMaterial.SetVector(m_KeyParallax, ringParallax);
        ...
        void Initialise()
        {
            if (m_Camera != null && m_MeshRenderer != null)
            {
                ...
                m_ScopeMaterial = m_MeshRenderer.materials[m_MaterialIndex];

                // Apply render texture
                m_ScopeMaterial.SetTexture(k_ShaderParameterRenderTexture, m_RenderTexture);
