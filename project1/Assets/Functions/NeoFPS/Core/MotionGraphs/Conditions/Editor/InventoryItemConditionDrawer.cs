...
{
    [MotionGraphConditionDrawer(typeof(InventoryItemCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-inventoryitemcondition.html")]
    public class InventoryItemConditionDrawer : MotionGraphConditionDrawer
    {
