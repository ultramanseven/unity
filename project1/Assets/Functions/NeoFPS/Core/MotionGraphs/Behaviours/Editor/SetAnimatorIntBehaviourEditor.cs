    ...
    public class SetAnimatorIntBehaviourEditor : MotionGraphBehaviourEditor
    {
        ...
        void InspectEnterProperties()
        {
            ...
            if (type.enumValueIndex == 0)
                ...
                MotionGraphEditorGUI.ParameterDropdownField<IntParameter>(owner.container, serializedObject.FindProperty("m_OnEnterParameter"));
        }
        ...
        void InspectExitProperties()
        {
            ...
            if (type.enumValueIndex == 0)
                ...
                MotionGraphEditorGUI.ParameterDropdownField<IntParameter>(owner.container, serializedObject.FindProperty("m_OnExitParameter"));
        }
    }
}
