...
namespace NeoFPSEditor.CharacterMotion
{
    public class MotionGraphEditorViewport
    {
        ...
        IMotionGraphElement m_LastClickedElement = null;
                                                ...
                                                case EventModifiers.None:
                                                    {
                                                        ...
                                                        if (clickTime - m_LastClickTime < k_DoubleClickTimeout)
                                                        {
                                                            ...
                                                            if (element is MotionGraph over && element == m_LastClickedElement)
                                                            {
                                                            ...
                                                            {
                                                                if (element == null && m_LastClickedElement == null && !editor.currentContext.isRoot)
                                                                {
