...
namespace NeoFPS.CharacterMotion.States
{
    ...
    public class JumpState : MotionGraphState
    {
        ...
        [SerializeField, Tooltip("The minimum distance the jump should attempt to move before completing. This prevents small jump heights or a very small fixed time step causing the jump to be too small to overcome ground snapping / detection.")]
        ...
        private float m_JumpDistance = 0f;
        private bool m_Completed = false;
        
        public override bool completed
        {
            get { return m_Completed && m_JumpDistance >= m_MinimumDistance; }
        }
        ...
        {
            base.Initialise(c);
            m_JumpPhysics = 2f * -Vector3.Dot(characterController.gravity, characterController.up);
        }
        ...
        public override void Update()
        {
            ...
            m_JumpDistance += m_OutVelocity.magnitude * Time.deltaTime;
        }
