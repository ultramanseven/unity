...
namespace NeoFPS
{
    ...
    public class HudAdvancedCrosshair : PlayerCharacterHudBase
    {
        ...
        {
            if (m_Crosshairs[m_CurrentCrosshair] != null && source != null && source.controller != null && source.controller.isLocalPlayer)
            {
                m_Crosshairs[m_CurrentCrosshair].ShowHitMarker(result == DamageResult.Critical);
            }
        }
    }
}