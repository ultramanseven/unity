...
namespace NeoFPS
{
	public struct PhysicsFilter
	{
		...
		public static class Masks
		{
            ...
            // Layer mask for carryable objects
            public static readonly PhysicsFilter CarryValid = new PhysicsFilter(LayerFilter.Default | LayerFilter.DynamicProps | LayerFilter.SmallDynamicObjects);
            public static readonly PhysicsFilter CarryBlockers = new PhysicsFilter(LayerFilter.Default | LayerFilter.EnvironmentRough | LayerFilter.Doors | LayerFilter.MovingPlatforms);
