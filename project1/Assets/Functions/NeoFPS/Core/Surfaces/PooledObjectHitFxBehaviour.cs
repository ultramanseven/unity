...
namespace NeoFPS
{
    ...
    public class PooledObjectHitFxBehaviour : BaseHitFxBehaviour
    {
        ...
        [SerializeField, Min(10f), Tooltip("The maximum distance from the player camera that the effect will be shown.")]
        private float m_MaxRange = 500f;

        public override bool forceInitialise { get { return false; } }

        public override float maxRange { get { return m_MaxRange; } }
