...
{
    public class ManagerPage_Input : EmbeddedEditorPage<NeoFpsInputManagerBase>
    {
        public ManagerPage_Input(NeoFpsInputManagerBase targetObject) : base(targetObject)
        { }
