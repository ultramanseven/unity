...
namespace NeoFPSEditor.Hub.Pages
{
    public class FrontPage : HubPage
    {
        ...
        const string k_UrlSupportCodecks = "https://open.codecks.io/neofps";
        ...
        const string k_SupportMessage = "You can get support and report bugs via the NeoFPS discord. Alternatively, you can contact us via the support page on the website, or by emailing the support address. A list of known bugs and issues is maintained on the NeoFPS Codecks, along with a development roadmap for potential future features.";
        ...
        public override void OnGUI()
        {
            ...
            GUILayout.Space(20);
            ReadmeEditorUtility.DrawWebLink("Codecks", k_UrlSupportCodecks);
            EditorGUILayout.Space();
            EditorGUILayout.EndHorizontal();
