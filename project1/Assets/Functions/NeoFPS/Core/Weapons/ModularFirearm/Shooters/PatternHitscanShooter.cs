...
namespace NeoFPS.ModularFirearms
{
    ...
    public class PatternHitscanShooter : BaseShooterBehaviour, IUseCameraAim
    {
        ...
        protected override void Awake()
        {
            ...
            m_Shots = new ShotInfo[m_PatternPoints.Length];
        }
        ...
        public override void Shoot(float accuracy, IAmmoEffect effect)
        {
            ...
            for (int i = 0; i < m_PatternVectors.Length; ++i)
            {
                ...
                m_Shots[i].shotDirection = aimRotation * m_PatternVectors[i];
                ...
                if (useCamera)
                {
                    m_Shots[i].shotDirection = m_Shots[i].hit.point - muzzlePosition;
                    m_Shots[i].shotDirection.Normalize();
                    ray = new Ray(muzzlePosition, m_Shots[i].shotDirection);
