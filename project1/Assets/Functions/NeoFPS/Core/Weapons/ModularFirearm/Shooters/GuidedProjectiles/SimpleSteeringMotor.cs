...
namespace NeoFPS.ModularFirearms
{
    ...
    public class SimpleSteeringMotor : MonoBehaviour, IGuidedProjectileMotor, INeoSerializableComponent
    {
        ...
        [Range(0f, 1080f), SerializeField, Tooltip("An increase to the turn rate based on elapsed time in flight (base turn rate + turn grow rate * elapsed time).")]
        ...
        public Vector3 GetVelocity(Vector3 currentPosition)
        {
            ...
            return transform.forward * m_Speed;
        }
        ...
        public Vector3 GetVelocity(Vector3 currentPosition, Vector3 targetPosition)
        {
            ...
            // Apply rotation
            //transform.rotation = Quaternion.LookRotation(forwards);
