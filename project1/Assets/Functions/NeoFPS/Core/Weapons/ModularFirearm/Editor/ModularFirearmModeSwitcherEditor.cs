...
namespace NeoFPSEditor.ModularFirearms
{
    ...
    public class ModularFirearmModeSwitcherEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_RegisterOnStart"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_FireEventOnStart"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_OnSwitchAnimTrigger"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_ModeIndexAnimInteger"));
