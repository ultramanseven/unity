...
namespace NeoFPSEditor
{
    public class NeoFpsEditorPrefs : ScriptableObject
    {
        ...
        [SerializeField]
        private bool m_DisableNeoObjectBrowsers = false;
        ...
        static NeoFpsEditorPrefs GetPreferences()
        {
            ...
            if (s_Instance != null)
            {
                if (s_Instance.m_SerializedObject == null)
                    s_Instance.m_SerializedObject = new SerializedObject(s_Instance);
                return s_Instance;
            }
        ...
        public static bool disableNeoObjectBrowsers
        {
            get
            {
                var prefs = GetPreferences();
                if (prefs != null)
                    return prefs.m_DisableNeoObjectBrowsers;
                else
                    return false;
            }
            set
            {
                var prefs = GetPreferences();
                if (prefs != null && prefs.m_DisableNeoObjectBrowsers != value)
                {
                    prefs.m_SerializedObject.FindProperty("m_DisableNeoObjectBrowsers").boolValue = value;
                    prefs.m_SerializedObject.ApplyModifiedPropertiesWithoutUndo();
                }
            }
        }
