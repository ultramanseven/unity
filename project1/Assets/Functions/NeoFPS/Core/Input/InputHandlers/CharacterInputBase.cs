...
namespace NeoFPS
{
    ...
    public abstract class CharacterInputBase : FpsInput
    {
        ...
        protected bool allowMoveInput {  get { return m_Character.allowMoveInput; } }
        protected bool allowLookInput { get { return m_Character.allowLookInput; } }
        protected bool allowWeaponInput { get { return m_Character.allowWeaponInput; } }
