...
namespace NeoFPS
{
    ...
    public class DrowningMotionGraphWatcher : MonoBehaviour, IDamageSource, INeoSerializableComponent
    {
        ...
        public float holdBreathDuration
        {
            ...
            set
            {
                if (m_HoldBreathDuration != value)
                {
                    m_HoldBreathDuration = value;
                    m_BreathRemaining = Mathf.Clamp(m_BreathRemaining, 0f, m_HoldBreathDuration);
        ...
        {
            writer.WriteValue(k_DurationKey, m_HoldBreathDuration);
        }

        public void ReadProperties(INeoDeserializer reader, NeoSerializedGameObject nsgo)
        {
            reader.TryReadValue(k_DurationKey, out m_HoldBreathDuration, m_HoldBreathDuration);
        }
