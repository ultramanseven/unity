...
namespace NeoFPS.Samples
{
	...
	public abstract class BaseMenu : FpsInputBase
	{
		...
		private bool m_WasShownThisFrame = false;
        ...
        {
            if (!m_WasShownThisFrame && NeoFpsInputManagerBase.wasCancelPressedThisFrame)
                Cancel();

			m_WasShownThisFrame = false;
		}
